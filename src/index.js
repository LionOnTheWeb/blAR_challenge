...
*
* 2) Please add a UI element which allows the user to change the color of the cubes in the scene. When the user selects a new color, all of the cubes that are present in the scene should be given the new color. Please include at least 5 different color options.
*
